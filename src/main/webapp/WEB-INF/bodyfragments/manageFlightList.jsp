...
<sf:form action="${addSearch}" method="post" modelAttribute="form">
			...
			<div class="col">
				<s:bind path="flightName">
					<div class="input-group">
						<sf:input path="flightName" type="text" placeholder="Flight Name "
							class="form-control" />
					</div>
				</s:bind>
			</div>
		...
		<tbody>
			<c:forEach items="${list}" var="mg" varStatus="cn">
				<tr>
					...
					<td><a href="${editUrl}${mg.id}" class="btn btn-primary">Edit</a>
					</td>
				</tr>
			</c:forEach>
	...
	<div style="margin: 10px" class="row row-cols-5">
		...
		<div class="col">
			<div class="input-group">
				<input type="submit" name="operation"
					...
					class="btn btn-primary" value="Cancel Flight">
			</div>
		</div>
		<div class="col">
			<div class="input-group">
