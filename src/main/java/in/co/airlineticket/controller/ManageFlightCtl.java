...
import in.co.airlineticket.form.ManageFlightForm;
import in.co.airlineticket.service.AirportServiceInt;
import in.co.airlineticket.service.FlightServiceInt;
import in.co.airlineticket.service.ManageFlightServiceInt;
...
public class ManageFlightCtl extends BaseCtl {
	...
	public String searchList(HttpSession session, @ModelAttribute("form") ManageFlightForm form,
		...
		if (OP_Cancel_Flight.equalsIgnoreCase(operation)) {
			...
			if (form.getIds() != null) {
				...
				model.addAttribute("success", "Flight Cancled Successfully");
			} else {
