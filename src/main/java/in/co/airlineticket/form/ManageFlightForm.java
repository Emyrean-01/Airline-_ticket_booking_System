...
public class ManageFlightForm extends BaseForm {
	...
	@Min(value = 1, message = "Arrival airport name is required")
	private long arrivalAirportId;
	@Min(value = 1, message = "Departure airport name is required")
	...
	@Pattern(regexp = "^(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\\d\\d$", message = "Arrival date is Invalid")
	private String arrivalDate;
	@NotEmpty(message = "Departure Date is required")
	@Pattern(regexp = "^(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\\d\\d$", message = "Departure date is Invalid")
